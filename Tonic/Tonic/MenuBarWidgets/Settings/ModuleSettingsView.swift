...
private struct WidgetModuleListItem: View {
...
private struct CPUModuleSettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DesignTokens.Spacing.md) {
            // Update Interval
            WidgetSettingsRow(label: "Update Interval", icon: "clock") {
            ...
            // Top Process Count
            WidgetSettingsRow(label: "Top Processes", icon: "list.bullet") {
                HStack(spacing: DesignTokens.Spacing.sm) {
